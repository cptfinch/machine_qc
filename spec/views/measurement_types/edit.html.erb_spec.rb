...
describe "/measurement_types/edit.html.erb" do
  ...
  it "should render edit form" do
    render "/measurement_types/edit.html.erb"
    
    response.should have_tag("form[action=#{measurement_type_path(@measurement_type)}][method=post]") do
